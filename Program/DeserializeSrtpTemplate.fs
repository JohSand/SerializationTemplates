...
//        static member Deserialize(arg1: JsonReader<'x>) : string = "1"

//    interface ExtendedDeserializable<int> with
//        static member Deserialize(arg1: JsonReader<'x>) : int = 1

//    interface ExtendedDeserializable<float> with
//        static member Deserialize(arg1: JsonReader<'x>) : float = 2
